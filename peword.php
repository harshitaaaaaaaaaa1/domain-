...
<body>
  ...
  <div class="destination" id="domainDestination">
    ...
    $domains = file("websites.txt", FILE_IGNORE_NEW_LINES);

    // Generate screenshot URLs for each domain
    $count = 0;
    foreach($domains as $domain) {
      $screenshotUrlCoIn = "https://s0.wp.com/mshots/v1/https://{$domain}.pe?w=200";
      $screenshotUrlIn = "https://s0.wp.com/mshots/v1/https://{$domain}.com.pe?w=200";

      echo '<div class="destination-item">';
      echo '<img src="' . $screenshotUrlCoIn . '" alt="' . $domain . '">';
      echo '<h3>' . $domain . '.pe</h3>';
      echo '<img src="' . $screenshotUrlIn . '" alt="' . $domain . '">';
      echo '<h3>' . $domain . '.com.pe</h3>';
      echo '</div>';
