...
<body>
  ...
  <div class="destination" id="domainDestination">
    ...
    foreach($domains as $domain) {
      $screenshotUrlCoIn = "https://s0.wp.com/mshots/v1/https://{$domain}.uk?w=200";
      $screenshotUrlIn = "https://s0.wp.com/mshots/v1/https://{$domain}.co.uk?w=200";

      echo '<div class="destination-item">';
      echo '<img src="' . $screenshotUrlCoIn . '" alt="' . $domain . '">';
      echo '<h3>' . $domain . '.uk</h3>';
      echo '<img src="' . $screenshotUrlIn . '" alt="' . $domain . '">';
      echo '<h3>' . $domain . '.co.uk</h3>';
      echo '</div>';
